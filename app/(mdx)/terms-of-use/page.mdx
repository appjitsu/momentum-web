...
-   **Company** (referred to as either "the Company", "We", "Us" or "Our" in
    this Agreement) refers to Momentum Software, LLC, 2307 Culpeper Midland,
    TX 79705.
...
-   **Third-party Social Media Service** means any services or content
    ...
    Service.
-   **Website** refers to Momentum Software, accessible from
    [http://www.momentumsoftware.io](http://www.momentumsoftware.io)
