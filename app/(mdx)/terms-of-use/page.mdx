...
-   **Company** (referred to as either "the Company", "We", "Us" or "Our" in
    this Agreement) refers to Momentum Digital, LLC, 2307 Culpeper Midland,
    TX 79705.
...
-   **Terms and Conditions** (also referred as "Terms") mean these Terms and
    ...
    [Terms and Conditions Generator](https://www.termsfeed.com/terms-conditions-generator/).
-   **Third-party Social Media Service** means any services or content
    ...
    Service.
-   **Website** refers to Momentum Digital, accessible from
    [http://www.momentumdigitaltx.com](http://www.momentumdigitaltx.com)
